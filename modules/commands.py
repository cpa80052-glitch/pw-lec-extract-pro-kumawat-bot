...
def register_commands_handlers(bot):
    ...
    async def cmd(client, callback_query):
        ...
        InputMediaPhoto(
          media="https://instasize.com/p/27be72f7aca05ec9d0434398bfa4f2f949461024d232d17dffd546736c4ec134",
          caption=caption
        ),
...
# .....,.....,.......,...,.......,....., .....,.....,.......,...,.......,.....,
    ...
    async def help_button(client, callback_query):
      ...
      await callback_query.message.edit_media(
        InputMediaPhoto(
          media="https://instasize.com/p/68277e7c3669afbe514ddb13d178fd00d575a0f6bddaa5cb4e22543489a86322",
          caption=caption
        ),
        reply_markup=keyboard
        )
